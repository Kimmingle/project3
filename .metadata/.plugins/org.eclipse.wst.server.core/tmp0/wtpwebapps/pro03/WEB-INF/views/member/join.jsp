    		...
    		<div class="page-wrap">
            	<form name="frm1" id="frm1" action="${path2 }/member/joinPro.do" method="post" onsubmit="return joinCheck(this)">
                	<table id="table1">
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input type="text" name="id" id="id" placeholder="아이디 입력"  maxlength="12" class="input" required style="width:700px; float:left;">
	            ...
	            <script>
	                function idCheck(){
	                    ...
	                    $.ajax({
	                        url:"${path2 }/member/idCheck.do?id="+ $("#id").val(),	//아이디가 전송되어질 곳(파라미터로 보냄)
	                        type:"get",		//전송방식
	                        dataType:"json",	//데이터 반환 방식
	                        //data:params,		//전송방식이 post인 경우 객체로 묶어서 전송(여긴 get)
